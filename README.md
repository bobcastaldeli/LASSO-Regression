# [Implementação do Algoritmo Regressão de LASSO via Coordinate Descent](https://nbviewer.jupyter.org/github/bobcastaldeli/LASSO-Regression/blob/master/LassoRegression.ipynb)
